 ...
 */
module.exports = function Bitmex(apiKey, apiSecret) {
  ...
  return {
    ...
    getAnnouncement: function (params) {
      return publicCall('/api/v1/announcement', 'GET', params);
    },
    ...
    getChat: function (params) {
      return publicCall('/api/v1/chat', 'GET', params);
    },
    ...
    getChatChannels: function () {
      return publicCall('/api/v1/chat/channels', 'GET', {});
    },
    ...
    getChatConnected: function () {
      return publicCall('/api/v1/chat/connected', 'GET', {});
    },
    ...
    getFunding: function (params) {
      return publicCall('/api/v1/funding', 'GET', params);
    },
    ...
    */
    ...
    getInstrument: function (params) {
      return publicCall('/api/v1/instrument', 'GET', params);
    },
    ...
    getInstrumentActive: function () {
      return publicCall('/api/v1/instrument/active', 'GET', {});
    },
    ...
    getInstrumentActiveAndIndices: function () {
      return publicCall('/api/v1/instrument/activeAndIndices', 'GET', {});
    },
    ...
    getInstrumentActiveIntervals: function () {
      return publicCall('/api/v1/instrument/activeIntervals', 'GET', {});
    },
    ...
    getInstrumentCompositeIndex: function (params) {
      return publicCall('/api/v1/instrument/compositeIndex', 'GET', params);
    },
    ...
    getInstrumentIndices: function () {
      return publicCall('/api/v1/instrument/indices', 'GET', {});
    },
    ...
    getInsurance: function (params) {
      return publicCall('/api/v1/insurance', 'GET', params);
    },
    ...
    getLeaderboard: function (params) {
      return publicCall('/api/v1/leaderboard', 'GET', params);
    },
    ...
    getLiquidation: function (params) {
      return publicCall('/api/v1/liquidation', 'GET', params);
    },
    ...
    getOrderBookL2: function (params) {
      return publicCall('/api/v1/orderBook/L2', 'GET', params);
    },
    ...
    getQuote: function (params) {
      return publicCall('/api/v1/quote', 'GET', params);
    },
    ...
    getQuoteBucketed: function (params) {
      return publicCall('/api/v1/quote/bucketed', 'GET', params);
    },
    ...
    getSchema: function (params) {
      return publicCall('/api/v1/schema', 'GET', params);
    },

    /**
     * Get websocket schema help.
     *
     * @param {Object} params Params for getting websocket schema help.
     */
    getSchemaWebsocketHelp: function (params) {
      return publicCall('/api/v1/schema/websocketHelp', 'GET', params);
    },
    ...
    getSettlement: function (params) {
      return publicCall('/api/v1/settlement', 'GET', params);
    },
     ...
     */
    getStats: function () {
      return publicCall('/api/v1/stats', 'GET', {});
    },
    ...
    getStatsHistory: function () {
      return publicCall('/api/v1/stats/history', 'GET', {});
    },
    ...
    getStatsHistoryUsd: function () {
      return publicCall('/api/v1/stats/historyUSD', 'GET', {});
    },
     ...
     */
    getTrade: function () {
      return publicCall('/api/v1/trade', 'GET', {});
    },
     ...
     */
    getTradeBucketed: function () {
      return publicCall('/api/v1/trade/bucketed', 'GET', {});
    },
     ...
     */
    getUser: function () {
      return privateCall('/api/v1/trade', 'GET', {});
    },
     ...
     */
    postUserWithdrawal: function (params) {

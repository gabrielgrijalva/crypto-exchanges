...
module.exports = function BybitRest(apiKey, apiSecret) {
  ...
  client.getOpenApiOrderList = function (params) {
    return privateCall('/open-api/order/list', 'GET', params);
  };
  ...
  client.postOpenApiOrderReplace = function (params) {
    return privateCall('/open-api/order/replace', 'POST', params);
  };
  client.getPrivateOrder = function (params) {
    return privateCall('/v2/private/order', 'GET', params);
  };
  client.postOpenApiStopOrderCreate = function (params) {
    return privateCall('/open-api/stop-order/create', 'POST', params);
  };
  client.getOpenApiStopOrderList = function (params) {
    return privateCall('/open-api/stop-order/list', 'GET', params);
  };
  client.postOpenApiStopOrderCancel = function (params) {
    return privateCall('/open-api/stop-order/cancel', 'POST', params);
  };
  client.postPrivateStopOrderCancelAll = function (params) {
    return privateCall('/v2/private/stop-order/cancelAll', 'POST', params);
  };
  client.postOpenApiStopOrderReplace = function (params) {
    return privateCall('/open-api/stop-order/replace', 'POST', params);
  };
  ...
  client.getUserLeverage = function () {
    return privateCall('/user/leverage', 'GET', {});
  };

...
module.exports = function OkexRest(apiKey, apiSecret, apiPassphrase) {
  ...
  return {
     ...
     */
    getSwapInstrumentsInstrumentIdCandles: function (instrumentId, params) {
      return publicCall(`/api/swap/v3/instruments/${instrumentId}/candles`,
        'GET', params);
    },
    ...
    /**
     * Get on hold amount open orders.
     *
     * @param {string} instrumentId Instrument id for getting on hold amount open orders.
     */
    getSwapAccountsInstrumentIdHolds: function (instrumentId) {
      return publicCall(`/api/swap/v3/accounts/${instrumentId}/holds`,
        'GET', null);
    },
     ...
     */
    getSwapInstrumentsInstrumentIdMarkPrice: function (instrumentId) {
      return publicCall(`/api/swap/v3/instruments/${instrumentId}`
        + '/mark_price', 'GET', null);
    },

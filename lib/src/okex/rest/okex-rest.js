...
module.exports = function OkexRest(apiKey, apiSecret, apiPassphrase) {
  ...
  return {
    ...
    postFuturesAmendOrderInstrumentId: function (instrumentId, params) {
      return privateCall(`/api/futures/v3/amend_order/${instrumentId}`, 'POST', null, params);
    },
    postFuturesAmendBatchOrdersInstrumentId: function (instrumentId, params) {
      return privateCall(`/api/futures/v3/amend_batch_orders/${instrumentId}`, 'POST', null, params);
    },
    ...
    postSwapAmendOrderInstrumentId: function (instrumentId, params) {
      return privateCall(`/api/swap/v3/amend_order/${instrumentId}`,
        'POST', null, params);
    },
    postSwapAmendBatchOrdersInstrumentId: function (instrumentId, params) {
      return privateCall(`/api/swap/v3/amend_batch_orders/${instrumentId}`,
        'POST', null, params);
    },

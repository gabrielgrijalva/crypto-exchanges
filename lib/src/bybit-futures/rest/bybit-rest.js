...
module.exports = function BybitRest(apiKey, apiSecret) {
  ...
  client.postPrivateOrderCreate = function (params) {
    return privateCall('/futures/private/order/create', 'POST', params);
  };
  client.getPrivateOrderList = function (params) {
    return privateCall('/futures/private/order/list', 'GET', params);
  };
  client.postPrivateOrderCancel = function (params) {
    return privateCall('/futures/private/order/cancel', 'POST', params);
  };
  client.postPrivateOrderCancelAll = function (params) {
    return privateCall('/futures/private/order/cancelAll', 'POST', params);
  };
  client.postPrivateOrderReplace = function (params) {
    return privateCall('/futures/private/order/replace', 'POST', params);
  };
  client.getPrivateOrder = function (params) {
    return privateCall('/futures/private/order', 'GET', params);
  };
  client.postPrivateStopOrderCreate = function (params) {
    return privateCall('/futures/private/stop-order/create', 'POST', params);
  };
  client.getPrivateStopOrderList = function (params) {
    return privateCall('/futures/private/stop-order/list', 'GET', params);
  };
  client.postPrivateStopOrderCancel = function (params) {
    return privateCall('/futures/private/stop-order/cancel', 'POST', params);
  };
  client.postPrivateStopOrderCancelAll = function (params) {
    return privateCall('/futures/private/stop-order/cancelAll', 'POST', params);
  };
  client.postPrivateStopOrderReplace = function (params) {
    return privateCall('/futures/private/stop-order/replace', 'POST', params);
  };
  client.getPrivateStopOrder = function (params) {
    return privateCall('/futures/private/stop-order', 'GET', params);
  };
  client.getPrivatePositionList = function (params) {
    return privateCall('/futures/private/position/list', 'GET', params);
  };
  client.postPositionChangePositionMargin = function (params) {
    return privateCall('/futures/private/position/change-position-margin', 'POST', params);
  };
  client.postPrivatePositionTradingStop = function (params) {
    return privateCall('/futures/private/position/trading-stop', 'POST', params);
  };
  client.postPrivatePositionLeverageSave = function (params) {
    return privateCall('/futures/private/position/leverage/save', 'POST', params);
  };
  client.postPrivatePositionSwitchMode = function (params) {
    return privateCall('/futures/private/position/switch-mode', 'POST', params);
  };
  client.postPrivateTpslSwitchMode = function (params) {
    return privateCall('/futures/private/tpsl/switch-mode', 'POST', params);
  };
  client.postPrivatePositionSwitchIsolated = function (params) {
    return privateCall('/futures/private/position/switch-isolated', 'POST', params);
  };
  client.getPrivateExecutionList = function (params) {
    return privateCall('/futures/private/execution/list', 'GET', params);
  };
  client.getPrivateTradeClosedPnlList = function (params) {
    return privateCall('/futures/private/trade/closed-pnl/list', 'GET', params);
  };
  client.getPrivatePositionRiskLimit = function (params) {
    return privateCall('/futures/private/position/risk-limit', 'GET', params);
  };
  client.postPrivatePositionRiskLimit = function (params) {
    return privateCall('/futures/private/position/risk-limit', 'POST', params);
  };

...
const BASE_URL_PUBLIC = 'wss://ws.kraken.com';

/**
 * Checker process that validates that krakenWsConnection is open through ping/pong implementation.
 *
 */
...
module.exports = function KrakenWs(config) {
  ...
  onOpenFunctions.push(connectionChecker.bind(krakenWsConnection));
  onOpenFunctions.push(() => krakenWsConnection.send(JSON.stringify(
    request)));

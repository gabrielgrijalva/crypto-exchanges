...
const BASE_URL_GLOBAL = 'https://api.huobi.pro';
...
module.exports = function HuobiDM(apiKey, apiSecret) {
  ...
  const privateCallGlobal = privateCallCreator(BASE_URL_GLOBAL, apiKey, apiSecret);
  ...
  return {
    ...
    postContractPositionInfo: function (params) {
      return privateCall('/api/v1/contract_position_info', 'POST', null, params);
    },
    ...
    postContractSubAccountList: function (params) {
      return privateCall('/api/v1/contract_sub_account_list', 'POST', null, params);
    },
    ...
    postContractSubAccountInfo: function (params) {
      return privateCall('/api/v1/contract_sub_account_info', 'POST', null, params);
    },
    ...
    postContractSubPositionInfo: function (params) {
      return privateCall('/api/v1/contract_sub_position_info', 'POST', null, params);
    },
    ...
    postContractFinancialRecord: function (params) {
      return privateCall('/api/v1/contract_financial_record', 'POST', null, params);
    },
    ...
    postContractBatchOrder: function (params) {
      return privateCall('/v1/contract_batchorder', 'POST', null, params);
    },

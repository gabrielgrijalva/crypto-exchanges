...
module.exports = function Binance(apiKey, apiSecret) {
  ...
  return {
    ...
    getSystemStatus: function(){
      return publicCall('/wapi/v3/systemStatus', 'GET', {});
    },
    ...
    postWithdraw: function(params){
      return privateCall('/wapi/v3/withdraw', 'POST', params);
    },
    ...
    getDepositHistory: function(params){
      return privateCall('/wapi/v3/depositHistory', 'GET', params);
    },
    ...
    getWithdrawHistory: function(params){
      return privateCall('/wapi/v3/withdrawHistory', 'GET', params);
    },
    ...
    getDepositAddress: function(params){
      return privateCall('/wapi/v3/depositAddress', 'GET', params);
    },
    getAccountStatus: function(){
      return privateCall('/wapi/v3/accountStatus', 'GET', {});
    },
    getApiTradingStatus: function(){
      return privateCall('/wapi/v3/apiTradingStatus', 'GET', {});
    },
    getUserAssetDribbletLog: function(){
      return privateCall('/wapi/v3/userAssetDribbletLog', 'GET', {});
    },
    ...
    getAssetDetail: function(){
      return privateCall('/wapi/v3/assetDetail', 'GET', {});
    },
    getTradeFee: function(params){
      return privateCall('/wapi/v3/tradeFee', 'GET', params);
    },
    // SPOT ACCOUNT/TRADE

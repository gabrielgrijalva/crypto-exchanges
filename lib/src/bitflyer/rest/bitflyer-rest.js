...
module.exports = function BitflyerRest(apiKey, apiSecret) {
  ...
  return {
     ...
     */
    getBoardState: function (params) {
      return publicCall('/v1/getboardstate', 'GET', params);
    },
     ...
     *
     */
    getMeCollateralAccounts: function () {
      return privateCall('/v1/me/getcollateralaccounts', 'GET', null, null);
    },
